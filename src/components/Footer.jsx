...
const Footer = () => {
  return (
    <div data-scroll data-scroll-speed=".1" className='flex gap-5 justify-between w-full h-screen sm-p-20 p-10 font-["Founders_Grotesk_X-condensed"]'>
      ...
      <div className='w-[3/4] text-right flex flex-col justify-evenly'>
        <h1 className='text-[5vw] uppercase leading-none -mb-6 font-semibold'>
          Presentation
        </h1>
        <div className="linkcontainer text-[16px] flex flex-col justify-between flex-wrap">
